...
static inline void put32_raw(volatile uint32_t *addr, uint32_t v) {
    *addr = v;
}
...
static inline void gpio_set_on_raw(unsigned pin) {
    put32_raw((volatile uint32_t *) (0x2020001c), (1 << pin));
}
static inline void gpio_set_off_raw(unsigned pin) {
    put32_raw((volatile uint32_t *) (0x20200028), (1 << pin));
}
...
static inline void write_1(unsigned pin, unsigned ncycles) {
    ...
    gpio_set_on_raw(pin);
    delay_ncycles(start_cyc, ncycles - compensation);
}
